...
def main(args):
    ...
    agent_weights_path = "/home/runnphoenix/work/flatland-rl/rainbow/test_results/checkpoint_1_agents_on_25_25/epoch_90_26_01_2022__01_22_"
    ...
    if True:
        for ep in range(n_trials):
            ...
            for step in range(max_steps):
                ...
                for a in range(env.get_num_agents()):
                    ep_controller.save_experience_and_train(a, railenv_action_dict[a], all_rewards[a], next_obs[a], done[a], step, args, ep, train=False)
