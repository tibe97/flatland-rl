...
class EpisodeController():
    ...
    def compute_agent_action(self, handle, info, eps, mf):
        ''' 
            ...
            To summarize, when we reach a switch, we select the node to reach and we compute the RailEnvActions needed to reach it.
            The next decision node is computed only when have reached the new swtich at the end of the previously selected node.
        '''
        next_action = 0
