...
class RainbowAgent():
    def __init__(self, args, feature_size):
        ...
        self.online_net = DQN(args, self.feature_size, self.agents_messages).to(device)
        ...
        self.target_net = DQN(args, self.feature_size, self.agents_messages).to(device)
    ...
    def act_e_greedy(self, state, epsilon=0.001):  # High ε can reduce evaluation scores drastically
        return np.random.randint(0, 4) if random() < epsilon else self.act(state)
